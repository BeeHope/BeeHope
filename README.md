...
|---|---------|-------|--------|
| 🔒 | **Network Attack Detection — Evil Twin & DDoS** | Python · Aircrack-ng · ML · Scapy | Network Security |
| ⚙️ | **Kubernetes Cluster Automation** | Bash · K8s · Flannel CNI · containerd | Infrastructure |
| 🖥️ | **VMware vSphere VM Deployer** | Python · PyVmomi · YAML | Automation |
| 📊 | **Phone Price Predictor — ML Web App** | Python · Scikit-learn · Flask | Machine Learning |
| 💬 | **Instant Messaging App** | Java · Docker · WebSocket | Secure Dev |
| 🌐 | **University Network Simulation** | Cisco Packet Tracer · VLAN · OSPF | Networking |
| 📱 | **Health Vault — Android App** | Android · Kotlin | Mobile Dev |
...
```
  ...
  ☁️  Cloud Security — AWS & Terraform
  🏁  CTF Competitions
```
